...
func CreateSideInputLocation() map[string]data.Location {

	// coordinate

	return map[string]data.Location{
		"TF1": data.Location{
			Coordinate: data.Coordinate{X: 34.551430, Y: 7.306936},
			Rotation:   true,
			Length:     5,
			Width:      12,
			IsFixed:    false,
		...
		"TF2": data.Location{
			Coordinate: data.Coordinate{X: 108.311238, Y: 8.959338},
			Rotation:   true,
			Length:     5,
			Width:      12,
			IsFixed:    false,
		...
		"TF3": data.Location{
			Coordinate: data.Coordinate{X: 4.369674, Y: 7.260322},
			Rotation:   false,
			Length:     8,
			Width:      14,
			IsFixed:    false,
		...
		"TF4": data.Location{
			Coordinate: data.Coordinate{X: 104.347527, Y: 38.058604},
			Rotation:   false,
			Length:     14,
			Width:      7,
			IsFixed:    false,
		...
		"TF5": data.Location{
			Coordinate: data.Coordinate{X: 84.207558, Y: 64.782349},
			Rotation:   true,
			Length:     7,
			Width:      14,
			IsFixed:    false,
		...
		"TF6": data.Location{
			Coordinate: data.Coordinate{X: 117.818767, Y: 92.673680},
			Rotation:   false,
			Length:     4,
			Width:      4,
			IsFixed:    false,
		...
		"TF7": data.Location{
			Coordinate: data.Coordinate{X: 32.475737, Y: 6.784953},
			Rotation:   false,
			Length:     10,
			Width:      12,
			IsFixed:    false,
		...
		"TF8": data.Location{
			Coordinate: data.Coordinate{X: 101.023480, Y: 18.103534},
			Rotation:   true,
			Length:     6,
			Width:      12,
			IsFixed:    false,
		...
		"TF9": data.Location{
			Coordinate: data.Coordinate{X: 47.163815, Y: 37.001098},
			Rotation:   false,
			Length:     12,
			Width:      6,
			IsFixed:    false,
		...
		"TF10": data.Location{
			Coordinate: data.Coordinate{X: 101.054167, Y: 17.159174},
			Rotation:   true,
			Length:     6,
			Width:      10,
			IsFixed:    false,
		...
		"TF11": data.Location{
			Coordinate: data.Coordinate{X: 3.567509, Y: 87.419745},
			Rotation:   false,
			Length:     6,
			Width:      4,
			IsFixed:    false,
		...
		"TF12": data.Location{
			Coordinate: data.Coordinate{X: 12.545486, Y: 80.868169},
			Rotation:   false,
			Length:     8,
			Width:      6,
			IsFixed:    false,
